...
import blackForest from '../assets/black forest cake.jpeg';
import bread from '../assets/bread.jpg';
import garlicBread from '../assets/Garlic-Bread.webp';
import chocolateCake from '../assets/chocolate cake.webp';
import chocolatechips from '../assets/Chocolate Chip Cookies.jpg';
import ButterCookies from '../assets/Butter Cookies.webp';
...
function Bekrey() {
  ...
  const handleAddToCart = (item) => {
    ...
    const isAlreadyInCart = storedItems.some((cartItem) => cartItem.name === item.name);
  ...
  const handleBuyNow = async () => {
    try {
      ...
      console.log("🛠️ Server Response:", response.data);
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center min-h-screen bg-amber-100 p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-[60rem] ">
